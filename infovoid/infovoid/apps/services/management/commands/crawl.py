...
from infovoid.apps.services import crawlers
        ...
        for slug in service_slugs:
            if slug == 'nytimes' and not settings.NYTIMES_API_KEY:
                self.stdout.write(self.style.ERROR(
                    ...
                    'Read more: https://github.com/Listen-Dinle/infovoid#the-new-york-times'
                ))
                continue
            ...
            if slug == 'producthunt' and not settings.PRODUCT_HUNT_TOKEN:
                self.stdout.write(self.style.ERROR(
                    ...
                    'Read more: https://github.com/Listen-Dinle/infovoid#product-hunt'
                ))
                continue
