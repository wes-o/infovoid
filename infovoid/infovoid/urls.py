...
from infovoid.apps.core import views as core_views
from infovoid.apps.services import views as services_views
...
urlpatterns = [
    ...
    path('<slug:slug>/', include('infovoid.apps.services.urls', namespace='services')),
]
